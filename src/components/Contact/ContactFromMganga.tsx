...
import { useCreateContactMMutation } from '../../redux/api/contactsMgangaApiSlice';
 
const ContactFromMganga: React.FC = () => {
  ...
  const [createContact, { isLoading  }] = useCreateContactMMutation();
...
export default ContactFromMganga;
